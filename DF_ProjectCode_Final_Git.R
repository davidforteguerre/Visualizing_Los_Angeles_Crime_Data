...
# to pass professor's test for dataset selection requirement
testresult = (dim(LAcrime)[1] * 4) * (dim(LAcrime)[2]/100) # dim[1] retrieves the # of rows, dim()[2] retrieves the # of colums
testresult >= 100 # is this is a good dataset? YES!
testresult # to see the actual score
